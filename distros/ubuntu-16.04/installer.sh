...
# Mailman
    ...
    echo "mailmanmailman/default_server_language select en" | debconf-set-selections
    ...
    #echo "mailman mailman/site_languages multiselect en" | debconf-set-selections
    #echo "mailman mailman/default_server_language choices en" | debconf-set-selections
